...
- 2026-07-30:
  ...
  - Unificação de konfiguracoes `.env` entre repositórios e commit (commit 1c89af8).
  ...
  - Redesenhada a `LandingPage.tsx` no estilo SaaS Hero (inspiração Tripo.ai) com `mesh-bg`, `glass-panel`, hierarquia visual focada (Título -> Subtítulo -> CTA "Começar de Graça") e faixa de logotipos de autoridade.
